	...
	<div class="sprocket-mosaic-item" data-mosaic-content>
		...
		<div class="sprocket-padding">
			...
			<div class="sprocket-mosaic-image-container">
				...
				<?php if ($item->getPrimaryLink()) : ?>
					<a href="<?php echo $item->getPrimaryLink()->getUrl(); ?>" class="sprocket-readmore"><i class="fa fa fa-link"></i><span><?php rc_e('READ_MORE'); ?></span></a>
				<?php endif; ?>
			...
			<div class="sprocket-mosaic-content">
				...
				<div class="sprocket-mosaic-bottom">
				...
				<?php endif; ?>
				<span class="mosaic-hits"><i class="fa fa-heart-o"></i> <?php echo $item->getHits(); ?></span>
				</div>
			</div>
