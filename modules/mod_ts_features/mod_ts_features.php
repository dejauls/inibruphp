<?php
    ...
    */
    ...
    if( $params->get('genmore') ){
        $data[0][ 'genmore' ] = $params->get('genmore');
    }



    require(JModuleHelper::getLayoutPath('mod_ts_features', $layout) );