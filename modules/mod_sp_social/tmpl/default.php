...
?>	
	...
	<ul>
		...
		<?php if ($dribble) : //dribble ?>
			<li><a <?php echo $target ?> class="sp_social_dribble" title="<?php echo JText::_('SP_SOCIAL_DRIBBLE') ?>" href="http://www.dribble.com/<?php echo $dribble ?>"><span><?php echo JText::_('SP_SOCIAL_DRIBBLE') ?></span><?php echo $custom_text ?></a></li>
		<?php endif; ?>	
